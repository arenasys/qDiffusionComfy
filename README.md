...
- qComfy is remote only, similar to ComfyUI itself except the UI is local. It requires running comfy-inference-server manually. You can run qDiffsion and comfy-inference-server on the same machine of course.
